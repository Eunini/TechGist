...
export default function DashProfile() {
  ...
  // Set the profile picture to the Google user's default profile image
  const profilePictureUrl = currentUser.profilePicture || currentUser.photoURL;
  ...
  const handleSubmit = async (e) => {
    ...
    if (!currentUser?.token) {
      setUpdateUserError("Authentication error");
      return;
    }
