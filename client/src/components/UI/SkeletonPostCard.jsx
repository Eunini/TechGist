export default function SkeletonPostCard() {
  return (
    <div className='relative w-full h-[400px] rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden animate-pulse bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700'>
