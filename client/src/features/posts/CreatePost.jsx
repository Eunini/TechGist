    ...
    <div className='p-3 max-w-6xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col lg:flex-row gap-6' onSubmit={handleSubmit}>
        ...
        <div className='lg:w-80 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-4 border-2 border-gray-300 dark:border-gray-600 border-dashed p-4 rounded-lg'>
          ...
          {imageUploadProgress && (
            <Progress progress={imageUploadProgress} size="sm" color="cyan" />
          )}
